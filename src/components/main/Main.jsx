...
const Main = () => {
    return (
        <div className="flex flex-col md:flex-row bg-indigo-100 dark:bg-slate-100">
            <section className="w-auto md:w-[70%] h-full">
                <div className="w-full flex items-center justify-between">
                    <div className="text-indigo-950 m-4 font-bold text-xl md:text-2xl dark:text-transparent bg-clip-text dark:gradient-to-t1 from-indigo-100 to-pink-800">
                        Hello, Admin Ecommerce Management System
                    </div>
                ...
                <div className='grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4  gap-4 m-4'>
                    <div className='flex flex-col justify-between w-full md:w-auto h-48  bg-white dark:bg-slate-900/50 p-4 rounded-md '>
                        <div className='flex w-full items-center justify-between'>
                            <div><IoMdWallet className='text-4xl text-indigo-950 dark:text-slate-400' /></div>
                            <div className='flex items-center justify-center w-10 h-10 dark:text-slate-400 bg-indigo-200 dark:bg-slate-900/50 rounded-full'><MdOutlineMenu /> </div>
                        </div>
                    ...
                    <div className='flex flex-col justify-between w-full md:w-auto h-48 bg-white dark:bg-slate-900/50 p-4 rounded-md '>
                        <div className='flex w-full items-center justify-between'>
                            ...
                            <div className='flex items-center justify-center dark:text-slate-400 w-10 h-10 bg-indigo-200 dark:bg-slate-900 rounded-full'><MdOutlineMenu /></div>
                        </div>
                        <div className='font-extrabold text-4xl sm:text-2xl md:text-lg lg:text-xl text-indigo-950 dark:text-slate-400'> $500,634.00</div>
                        <div>
                    ...
                    <div className='flex flex-col justify-between w-full md:w-auto h-48 bg-white dark:bg-slate-900/50 p-4 rounded-md '>
                        <div className='flex w-full items-center justify-between'>
                            ...
                            <div className='flex items-center justify-center dark:text-slate-400 w-10 h-10 bg-indigo-200 dark:bg-slate-900/50 rounded-full'><MdOutlineMenu /></div>
                        </div>
                        <div className='font-extrabold text-4xl sm:text-2xl md:text-lg lg:text-xl text-indigo-950 dark:text-slate-400'> $500,634.00</div>
                        <div>
